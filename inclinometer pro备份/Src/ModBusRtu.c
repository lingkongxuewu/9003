...
static int16u xdata checkcode = 0;
int32u xdata baudsetnum;
...
int8u ChkCode(int8u *buf,int8u len)
{
	int8u i;
...
int8u Sumchk(int8u *buf,int8u len)
{				 
	int8u xdata i;
	int16u codedata = 0;
	for(i=1;(i<len);i++)
...
//           vol32u = pc_data ;
        ...
        case 0x0112:				 		//COMP_OFFSET_WR 磁偏角
        {
			CompOffset = pc_data;
			if(CompOffset>360)
				CompOffset=360;
        ...
        case 0x0113:		  				//COMP_CAL_STA
        {
           Comp_CalInit();
        }break ;
    
        case 0x0114:	   					//COMP_CAL_STOP
        {
			Comp_CalPrmtCnt();
			Flash_CalDataUpdate();
        }break ;
        ...
        case 0xA808:
        {
            ...
            switch( pc_data )
            {
                case   5: SetAngCalCnt(11) ;  break ;
                case  10: SetAngCalCnt(11) ;  break ;
                case  15: SetAngCalCnt(11) ;  break ;
                case  30: SetAngCalCnt(21) ;  break ;
                case  45: SetAngCalCnt(19) ;  break ;
                case  60: SetAngCalCnt(15) ;  break ;
                case  90: SetAngCalCnt(19);  break ;
 //               default : SetAngCalCnt(3) ;  break ;
        ...
        case 0xA80A:
        {
            ...
            vol16s = ( int16s )( vol16s /( int16s) (AngRange/( int16s )(GetAngXCalCnt() / 2)  )) ;
			//vol16s = ( int16s )( vol16s / 3 ) ;
            pc_data = vol16s + ( int16s )(GetAngXCalCnt() / 2) ;   //獲取角度校準點個數  
...
{
    {
        ...
        case 0x0115 : break ;//pc_data = AlarmHighLow                             ; break ;
        case 0x0116 : break ;//pc_data = FloatToInt( GetAngXSet(), 'L' )          ; break ;
        case 0x0117 : break ;//pc_data = FloatToInt( GetAngXSet(), 'H' )          ; break ;
        case 0x0118 : break ;//pc_data = FloatToInt( GetAngYSet(), 'L' )          ; break ;
        case 0x0119 : break ;//pc_data = FloatToInt( GetAngYSet(), 'H' )          ; break ;
        case 0x011A : break ;//pc_data = FloatToInt( GetAngPSet(), 'L' )          ; break ;
        case 0x011B : break ;//pc_data = FloatToInt( GetAngPSet(), 'H' )          ; break ;
        case 0x011C : break ;//pc_data = FloatToInt( AngAlarmOffset, 'L' )        ; break ;
        case 0x011D : break ;//pc_data = FloatToInt( AngAlarmOffset, 'H' )        ; break ;
...
//compass
        case 0xA002 : pc_data = CompVal                                    ; break ;		
        case 0xA003 : pc_data = CompOffset                                 ; break ;
        ...
        case 0xA101 : pc_data = GetXOftVal()                             ; break ;    //HXL 12/8/27
        ...
        case 0xA30B : pc_data = GetXOftVal()                                ; break ;
        case 0xA30C : pc_data = GetYOftVal()                                ; break ;
        ...
        case 0xA31F : break ;//pc_data = FloatToInt( GetAngXSet(), 'L' )             ; break ;
        case 0xA320 : break ;//pc_data = FloatToInt( GetAngXSet(), 'H' )             ; break ;
        case 0xA321 : break ;//pc_data = FloatToInt( GetAngYSet(), 'L' )             ; break ;
        case 0xA322 : break ;//pc_data = FloatToInt( GetAngYSet(), 'H' )             ; break ;
        case 0xA323 : break ;//pc_data = FloatToInt( GetAngPSet(), 'L' )             ; break ;
        case 0xA324 : break ;//pc_data = FloatToInt( GetAngPSet(), 'H' )             ; break ;
        case 0xA325 : break ;//pc_data = FloatToInt( AngAlarmOffset, 'L' )           ; break ;
        case 0xA326 : break ;//pc_data = FloatToInt( AngAlarmOffset, 'H' )           ; break ;
        ...
        case 0xA344 : pc_data = '9'*256+'8'                                 ; break ;
        case 0xA345 : pc_data = 2018                              		   ; break ;
        case 0xA346 : pc_data = 207                              		   ; break ;
...
//	int8u xdata i;
	...
	switch(buf[3])	
	{
		case 0x04:				  
				  ...
				  Int32s2val (val,GetXAngAllSetVal());

				  buf[4] = (int8u)(val[0]<<4)+val[1];
				  buf[5] = (int8u)(val[2]<<4)+val[3];
				  buf[6] = (int8u)(val[4]<<4)+val[5];
				  
				  Int32s2val (val,GetYAngAllSetVal());
				  buf[7] = (int8u)(val[0]<<4)+val[1];
				  buf[8] = (int8u)(val[2]<<4)+val[3];
				  buf[9] = (int8u)(val[4]<<4)+val[5];

				  buf[10] = 0x00;
				  buf[11] = 0x00;
				  buf[12] = 0x00;

				  Int32s2val (val,Get_McuTempInCelsius());
				  buf[13] = (int8u)(val[0]<<4)+0;
				  buf[14] = (int8u)(val[1]<<4)+val[2];
				  buf[15] = (int8u)(val[3]<<4)+0;

				  buf[16] = Sumchk(buf,buf[1]);
